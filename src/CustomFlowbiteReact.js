const CustomFlowbiteReact = {
    ...
    galeryCustom: {
        ...
        "control": {
            "base": "inline-flex h-8 w-8 items-center justify-center rounded-full bg-primary group-hover:bg-primaryLigth group-focus:outline-none group-focus:ring-4 group-focus:ring-primaryLigth sm:h-10 sm:w-10",
