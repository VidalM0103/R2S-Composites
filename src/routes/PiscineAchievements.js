        ...
        <>
            ...
            <main className="text-white bg-gray-800 font-poppins">
                <section className="min-h-[calc(100vh-180px)] flex flex-col items-center justify-around">
                    ...
                    <div className="h-[calc(600px)] w-[calc(1200px)]">

                        <Carousel slide={false}>
                            <div className="relative flex h-full justify-center items-center bg-gray-400 dark:bg-gray-700 dark:text-white w-auto">
                            ...
                            <div className="relative flex h-full justify-center items-center bg-gray-400 dark:bg-gray-700 dark:text-white">
