            ...
            <main className="text-white h-[calc(100vh-180px)] font-poppins">
                <section className="bg-gray-800 p-6 rounded-lg shadow-lg grid grid-cols-3 h-[calc(100vh-180px)]">
                    <div className="flex flex-col gap-4 items-center justify-evenly col-span-1">
                        <div >
                            <img src={process.env.PUBLIC_URL + "expertise/expertise-bateau-sonde.jpeg"} alt="" className="rounded-lg shadow-lg max-h-[350px]" />
                        </div>
                        <div className="flex items-center justify-center col-span-1">
                            <img src={process.env.PUBLIC_URL + "expertise/expertise-bateau-reunion.jpeg"} alt="" className="rounded-lg shadow-lg max-h-[350px]" />
                        </div>
                    </div>
