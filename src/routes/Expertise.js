    ...
    return (
        <>
            <header className="bg-yellow-300 text-white p-6 mt-24 font-poppins">
                <h1 className="text-2xl lg:text-3xl font-bold [text-shadow:_3px_3px_rgb(0_0_0_/40%)]">R2S Expertise Maritime - Présentation</h1>
            </header>
            ...
            <main className="text-white h-[calc(100vh-180px)] font-poppins">
                <section className="bg-gray-800 p-4 lg:p-8 lg:grid lg:grid-cols-3 h-[calc(100vh-180px)]">
                    ...
                    <div className="flex flex-col justify-evenly items-start col-span-2 text-lg">
                        <section>
                            <h3 className="text-xl lg:text-2xl font-bold text-yellow-300 mb-2">Expertise de pré-Transactionnelle</h3>
                        ...
                        <section>
                            <h3 className="text-xl lg:text-2xl font-bold text-yellow-300 mb-2">Expertise de sinistre</h3>
                        ...
                        <section>
                            <h3 className="text-xl lg:text-2xl font-bold text-yellow-300  mb-2">Expertise de pré-Assurance</h3>
                            <p className="mb-4">Cette expertise donne lieu à la rédaction d’un rapport basé sur les observations réalisées
                                sur le bateau. La valeur d’assurance du navire est estimée.</p>
                        </section>
                        <section>
                            <h3 className="text-xl lg:text-2xl font-bold text-yellow-300 mb-2">Suivi de chantier</h3>
                        ...
                        <section>
                            <h3 className="text-xl lg:text-2xl font-bold text-yellow-300 mb-2">Bilan osmotique (plan de sonde cardinale)</h3>
                            <p>Cette expertise permettra de contrôler l’humidité de la matrice, matérialisant éventuellement un phénomène
                                osmotique.</p>
                        </section>
                    </div>
                    <div className="flex flex-col gap-4 items-center justify-evenly col-span-1 m-4">
                        <div >
